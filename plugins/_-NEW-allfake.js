...
handler.all = async function (m) {
	...
	let pp = 'https://cdn.btch.bz/file/d503c60ffcc01b582dc39.jpg'
	try {
   ...
   global.pu = pp
	...
	global.kontak2 = [
	[owner[0], await conn.getName(owner[0] + '6285808492274@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'rizalfreall@gmail.com', true],
	[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'rizalfreall@gmail.com', true], ]
