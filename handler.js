...
this.reply(msg.key.remoteJid, `Terdeteksi *@${participant.split`@`[0]}* telah menghapus pesan.`)
...
let msg = {
    rowner: `${nmsr}\n\n*ᴏɴʟʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙᴏᴛ`,
    owner: `${nmsr}\n\n*ᴏɴʟʏ ᴏᴡɴᴇʀ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴏᴡɴᴇʀ ʙᴏᴛ`,
    mods: `${nmsr}\n\n*ᴏɴʟʏ ᴍᴏᴅᴇʀᴀᴛᴏʀ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴍᴏᴅᴇʀᴀᴛᴏʀ ʙᴏᴛ`,
    premium: `${nmsr}\n\n*ᴏɴʟʏ ᴘʀᴇᴍɪᴜᴍ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴘʀᴇᴍɪᴜᴍ ᴜsᴇʀ`,
    group: `${nmsr}\n\n*ɢʀᴏᴜᴘ ᴄʜᴀᴛ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪᴘᴀᴋᴀɪ ᴅɪᴅᴀʟᴀᴍ ɢʀᴏᴜᴘ`,
    private: `${nmsr}\n\n*ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪᴘᴀᴋᴀɪ ᴅɪᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ`,
        admin: `${nmsr}\n\n*ᴏɴʟʏ ᴀᴅᴍɪɴ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴀᴅᴍɪɴ ɢʀᴏᴜᴘ`,
        botAdmin: `${nmsr}\n\n*ᴏɴʟʏ ʙᴏᴛ ᴀᴅᴍɪɴ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪɢᴜɴᴀᴋᴀɴ ᴋᴇᴛɪᴋᴀ ʙᴏᴛ ᴍᴇɴᴊᴀᴅɪ ᴀᴅᴍɪɴ`,
        nsfw: `${nmsr}\n\nᴍᴏʜᴏɴ ᴍᴀᴀғ, ғɪᴛᴜʀ ɴsғᴡ ᴛɪᴅᴀᴋ ᴀᴋᴛɪғ sᴀᴀᴛ ɪɴɪ. sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ ᴛᴇᴀᴍ ʙᴏᴛ ᴅɪsᴄᴜssɪᴏɴ ᴜɴᴛᴜᴋ ᴍᴇɴɢᴀᴋᴛɪғᴋᴀɴ ғɪᴛᴜʀ ɪɴɪ!`,
        rpg: `${nmsr}\n\nᴍᴀᴀғ, ғɪᴛᴜʀ ʀᴘɢ ᴛɪᴅᴀᴋ ᴀᴋᴛɪғ sᴀᴀᴛ ɪɴɪ. sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ ᴛᴇᴀᴍ ʙᴏᴛ ᴅɪsᴄᴜssɪᴏɴ ᴜɴᴛᴜᴋ ᴍᴇɴɢᴀᴋᴛɪғᴋᴀɴ ғɪᴛᴜʀ ɪɴɪ!`,
        restrict: `${nmsr}\n\n*ʀᴇsᴛʀɪᴄᴛ* • ʀᴇsᴛʀɪᴄᴛ ʙᴇʟᴜᴍ ᴅɪɴʏᴀʟᴀᴋᴀɴ ᴅɪᴄʜᴀᴛ ɪɴɪ`,
}[type]

m.reply(msg)

let msgg = {
    unreg: `${nmsr}\n📝 Silahkan daftar ke database terlebih dahulu untuk menggunakan bot ini lebih lanjut. Gunakan perintah berikut:\n\n👉 .daftar namaAnda.umur\n\n👤 Contoh: .daftar orang.18\n\n`
}[type]
...
global.logo = 'https://telegra.ph/file/19e41947c0a6ae28dbf62.jpg'
global.hyuri = ['https://telegra.ph/file/395e20536473665ab2c5d.jpg']
global.thumb = 'https://telegra.ph/file/395e20536473665ab2c5d.jpg' 
global.imagebot = 'https://telegra.ph/file/395e20536473665ab2c5d.jpg'
...
global.thumbs = ['https://telegra.ph/file/395e20536473665ab2c5d.jpg']
